...
export const SettingsForm = () => {
  ...
  return (
    <div>
      ...
      <PomodoroTimer />
      <button
        className="bg-gray-300 text-gray-700 px-4 py-2 my-5 rounded-md hover:bg-gray-400"
        onClick={() => {
      ...
      <button
        className="bg-blue-500 text-white px-4 py-2 my-5 rounded-md hover-bg-blue-700"
